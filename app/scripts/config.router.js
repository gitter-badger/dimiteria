        ...
        function($stateProvider, $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
            ...
            $stateProvider
                ...
                .state('app.ui.scroll', {
                    ...
                    resolve: load('scripts/controllers/scroll.js')
                })
                ...
                .state('app.ui.toaster', {
                    ...
                    resolve: load(['toaster', 'scripts/controllers/toaster.js'])
                })
                ...
                .state('app.ui.googlemap', {
                    ...
                    resolve: load(['scripts/app/map/load-google-maps.js', 'scripts/app/map/ui-map.js', 'scripts/app/map/map.js'], function() {
                ...
                .state('app.table.grid', {
                    ...
                    resolve: load(['ngGrid', 'scripts/controllers/grid.js'])
                })
                ...
                .state('app.form', {
                    ...
                    resolve: load('scripts/controllers/form.js')
                })
                .state('app.form.components', {
                    url: '/components',
                    templateUrl: 'tpl/form_components.html',
                    resolve: load(['ngBootstrap', 'daterangepicker', 'scripts/controllers/form.components.js'])
                })
                ...
                .state('app.form.fileupload', {
                    ...
                    resolve: load(['angularFileUpload', 'scripts/controllers/file-upload.js'])
                })
                ...
                .state('access.signup', {
                    ...
                    resolve: load(['scripts/controllers/signup.js'])
                })
            ...
            .state('app.calendar', {
                ...
                resolve: load(['moment', 'fullcalendar', 'ui.calendar', 'scripts/app/calendar/calendar.js'])
            })
            ...
            .state('app.mail', {
                    ...
                    // use resolve to load other dependences
                    resolve: load(['scripts/app/mail/mail.js', 'scripts/app/mail/mail-service.js', 'moment'])
                })
                .state('app.mail.list', {
                    url: '/inbox/{fold}',
            ...
            .state('layout', {
                ...
                .state('layout.app', {
                    ...
                    resolve: load(['scripts/controllers/tab.js'])
                })
                .state('apps', {
                    abstract: true,
                    url: '/apps',
                ...
                .state('apps.note', {
                    ...
                    resolve: load(['scripts/app/note/note.js', 'moment'])
                })
                .state('apps.contact', {
                    url: '/contact',
                    templateUrl: 'tpl/apps_contact.html',
                    resolve: load(['scripts/app/contact/contact.js'])
                })
                .state('app.weather', {
                    url: '/weather',
                    templateUrl: 'tpl/apps_weather.html',
                    resolve: load(['scripts/app/weather/skycons.js', 'angular-skycons', 'scripts/app/weather/ctrl.js', 'moment'])
                })
                .state('app.todo', {
                    url: '/todo',
                    templateUrl: 'tpl/apps_todo.html',
                    resolve: load(['scripts/app/todo/todo.js', 'moment'])
                })
                .state('app.todo.list', {
                    url: '/{fold}'
                })
